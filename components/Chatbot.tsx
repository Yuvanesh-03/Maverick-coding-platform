        ...
        >
            ...
            >
                <div className="flex items-center gap-2">
                    <BirdIcon className="h-6 w-6 text-blue-500"/>
                    <h3 className="font-bold text-gray-900 dark:text-gray-100">Maverick Helper</h3>
                </div>
                <button 
            ...
            <div className="flex-grow p-4 overflow-y-auto space-y-4">
                {messages.map((msg, index) => (
                    <div key={index} className={`flex items-end gap-2 ${msg.sender === 'user' ? 'justify-end' : 'justify-start'}`}>
                       {msg.sender === 'bot' && <BirdIcon className="h-6 w-6 text-blue-500 flex-shrink-0" />}
                ...
                {isLoading && (
                     <div className="flex items-end gap-2 justify-start">
                        <BirdIcon className="h-6 w-6 text-blue-500 flex-shrink-0" />
