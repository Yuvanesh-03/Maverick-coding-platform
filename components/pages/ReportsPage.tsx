...
import { generateEnhancedAdminReport } from '../../utils/enhancedReportGenerator';
        ...
        <div className="space-y-6 animate-fade-in">
            <div className="flex justify-between items-center">
                ...
                <div className="flex gap-2">
                    ...
                    <Button onClick={() => generateAdminUsageReportPdf(analyticsData)} variant="secondary">Basic Report</Button>
                    <Button onClick={() => generateEnhancedAdminReport(analyticsData)} variant="primary">✨ Enhanced Report</Button>
                </div>
            </div>
