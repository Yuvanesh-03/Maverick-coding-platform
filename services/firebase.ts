...
const firebaseConfig = {
  apiKey: "AIzaSyD_wMpfzKu1whqmpgezBJ0TgAocFqux51w",
  ...
  storageBucket: "falcons-mavericks-platform.appspot.com",
...
export { app, auth, firestore, storage, googleProvider, analytics, serverTimestamp };